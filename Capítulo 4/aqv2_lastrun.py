...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\LAPS\\Downloads\\AQV-20170314T124325Z-001\\AQV\\aqv2.psyexp',
...
question = visual.TextStim(win=win, name='question',
    text=u'A imagem apresentada atende a crit\xe9rios essenciais de qualidade para se passar \xe0 etapa de emiss\xe3o de laudo ?',
    font=None,
...
x, y = [None, None]
rating_2 = visual.RatingScale(win=win, name='rating_2', marker='triangle', size=1.0, pos=[0.0, -0.7], choices=[u'Atende', u'N\xe3o atende'], tickHeight=-1)
...
image_test = visual.ImageStim(
    ...
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
rating = visual.RatingScale(win=win, name='rating', marker='triangle', size=1.0, pos=[0.0, -0.7], choices=[u'Atende', u'N\xe3o atende'], tickHeight=-1)
...
instructionsComponents = [title, question, goon, mouse_3, key_resp_2]
...
for thisTrial_2 in trials_2:
    ...
    # keep track of which components have finished
    trialComponents = [image_2, text_3, mouse, rating_2, key_resp_5]
...
# keep track of which components have finished
letsComponents = [key_resp_3, text_4, mouse_4]
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    experimentComponents = [image_test, rating, mouse_2, key_resp_4]
